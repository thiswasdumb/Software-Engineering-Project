...
class TestTF_IDF(unittest.TestCase):
    ...
    def test_keywords(self):
        ...
        for article, expected_sentiment in self.sample_tests.items():
            ...
            with self.subTest():
                top_20_search_terms = self.tf_idf.get_top_n_terms(20, article_index).split(',')
                top_20_search_terms_scores = self.tf_idf.get_top_n_terms_tfidf_scores(20, article_index)
