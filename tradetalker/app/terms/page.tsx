  ...
  return (
    <div className='m-8 flex flex-col rounded-lg bg-slate-200 p-8'>
      ...
      <p className='mt-2'>
        ...
        of the TradeTalk Website, located at{' '}
      ...
      <p className='mt-4'>
        ...
        conditions. Do not continue to use TradeTalk if you do not agree to take
        all of the terms and conditions stated on this page.
      </p>
      <p className='mt-4'>
        The following terminology applies to these Terms and Conditions, Privacy
        Statement and Disclaimer Notice and all Agreements: &quot;Client&quot;,
        &quot;You&quot; and &quot;Your&quot; refers to you, the person logging
        onto this website and compliant to the Company&apos;s terms and
        conditions. &quot;The Company&quot;, &quot;Ourselves&quot;,
        &quot;We&quot;, &quot;Our&quot; and &quot;Us&quot;, refers to TradeTalk
        Inc. &quot;Party&quot;, &quot;Parties%quot;, or &quot;Us&quot;, refers
        ...
        subject to, prevailing law of the United Kingdom. Any use of the above
      ...
      <p>
        We employ the use of cookies. By accessing TradeTalk, you agreed to use
        cookies in agreement with TradeTalk&apos;s{' '}
      ...
      <h2 className='mt-4 text-xl'>License</h2>
      <hr className='border-1 my-2 rounded-lg border-slate-400' />
      <p>
        Unless otherwise stated, TradeTalk and/or its licensors own the
        intellectual property rights for all material on TradeTalk. All
        intellectual property rights are reserved. You may access this from
        TradeTalk for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>
      <p className='mt-4'>You must not:</p>
      <ul className='ml-5 list-disc'>
        <li>Republish material from TradeTalk;</li>
        <li>Sell, rent or sub-license material from TradeTalk;</li>
        <li>Reproduce, duplicate or copy material from TradeTalk;</li>
        <li>Redistribute content from TradeTalk.</li>
      </ul>
      <p className='mt-4'>This Agreement shall begin on the date hereof.</p>
      <p className='mt-4'>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        TradeTalk does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of TradeTalk, its agents and/or affiliates. Comments reflect
        the views and opinions of the person who posts their views and opinions.
        To the extent permitted by applicable laws, TradeTalk shall not be
      ...
      <p className='mt-4'>
        TradeTalk reserves the right to monitor all Comments and to remove any
      ...
      <p className='mt-4'>
        You hereby grant TradeTalk a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media.
      </p>
      <h2 className='mt-4 text-xl'>Hyperlinking to our Content</h2>
      <hr className='border-1 my-2 rounded-lg border-slate-400' />
      <p>
      ...
      <p className='mt-4'>
        ...
        the hyperlink compensates the absence of TradeTalk; and (d) the link is
      ...
      <p className='mt-4'>
        ...
        email to TradeTalk. Please include your name, your organization name,
      ...
      <p className='mt-4'>
        No use of TradeTalk&apos;s logo or other artwork will be allowed for
        linking absent a trademark license agreement.
      </p>
      <h2 className='mt-4 text-xl'>iFrames</h2>
      <hr className='border-1 my-2 rounded-lg border-slate-400' />
      <p>
      ...
      <h2 className='mt-4 text-xl'>Content liability</h2>
      <hr className='border-1 my-2 rounded-lg border-slate-400' />
      <p>
      ...
      <h2 className='mt-4 text-xl'>Reservation of rights</h2>
      <hr className='border-1 my-2 rounded-lg border-slate-400' />
      <p>
      ...
      <h2 className='mt-4 text-xl'>Removal of links from our website</h2>
      <hr className='border-1 my-2 rounded-lg border-slate-400' />
      <p>
      ...
      <h2 className='mt-4 text-xl'>Disclaimer</h2>
      <hr className='border-1 my-2 rounded-lg border-slate-400' />
      <p>
