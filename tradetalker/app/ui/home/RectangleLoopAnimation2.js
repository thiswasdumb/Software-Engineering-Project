...
const RectangleLoopAnimation2 = () => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < numRectangles; i++) {
      ...
      rectangle.position.x = -i * rectangleSpacing; // Change direction here
      scene.add(rectangle);
    ...
    const animate = () => {
      ...
      rectangles.forEach((rectangle) => {
        rectangle.position.x += 0.02; // Change direction here
...
export default RectangleLoopAnimation2;
