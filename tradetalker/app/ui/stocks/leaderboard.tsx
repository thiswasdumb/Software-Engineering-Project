...
export default async function StockTrends() {
  ...
  return (
    <div className='md:w-[30%]'>
      ...
      <div className='bg-slate-300 mt-2 rounded-lg p-4'>
        {leaderboard.map((company, index) => (
          <Link key={index} href={`/company/${company.id}`}>
            <div className='bg-slate-200 hover:bg-slate-400 my-2 flex flex-row rounded-lg p-2 transition hover:bg-opacity-30 hover:drop-shadow-lg'>
